...
function Home() {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold bg-gradient-to-r from-purple-400 to-yellow-400 bg-clip-text text-transparent text-[32px]">The Community Showcase</h1>
      ...
      <div className="mt-10">
        {loading ? (
          ...
          <>
            {searchText && (
              <h2 className="font-medium text-[#676b6f] text-xl mb-3">Showing results for <span className="text-[#5c5c5f]">{searchText}</span></h2>
            )}

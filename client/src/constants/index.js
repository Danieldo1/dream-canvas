...
export const surpriseMePrompts = [
    ...
    'A circus of friendly robots juggling pixelated fruits in a virtual reality wonderland, Digital Art',
    'An ethereal mermaid made entirely of constellations swimming in a sea of liquid rainbow, Fantasy',
    'A steampunk cityscape where zeppelins shaped like giant animals roam the skies, Steampunk',
    'A majestic phoenix made of swirling galaxies soaring through the cosmos, Space Fantasy',
    'A whimsical tea party in an enchanted forest with animals wearing Victorian-era clothing, Fairytale',
    'A group of penguins having a disco party on an iceberg under the aurora borealis, Abstract Animation',
    'A psychedelic kaleidoscope of flowers morphing into exotic birds in a time-lapse animation, Abstract',
    'A mystical library in a hidden mountain cave, filled with books that glow with ancient wisdom, Magical Realism',
    'A cyberpunk street scene with holographic graffiti and neon-lit flying cars, Cyberpunk',
    'A magical doorway in the middle of a desert leading to a parallel universe of floating islands, Surreal',
